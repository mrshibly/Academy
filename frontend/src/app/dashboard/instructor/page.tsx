  ...
  return (
    <div style={{ padding: "3rem 0", minHeight: "80vh" }}>
      <div className="container">
        ...
        {/* Banner */}
        <div style={{ background: "var(--card-bg)", border: "1px solid var(--border-color)", borderRadius: "var(--radius-md)", padding: "2.5rem", marginBottom: "2.5rem" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              {data.courses.length === 0 ? (
                ...
                data.courses.map((course: any) => (
                  <div key={course.course_id} style={{ background: "var(--card-bg)", border: "1px solid var(--border-color)", borderRadius: "var(--radius-md)", padding: "1.5rem", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div>
